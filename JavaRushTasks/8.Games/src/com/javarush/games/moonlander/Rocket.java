...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> fireDownList = new ArrayList<>();
        fireDownList.add(ShapeMatrix.FIRE_DOWN_1);
        fireDownList.add(ShapeMatrix.FIRE_DOWN_2);
        fireDownList.add(ShapeMatrix.FIRE_DOWN_3);
            this.downFire = new RocketFire(fireDownList);
        List <int[][]> fireLeftAndRightList = new ArrayList<>();
        fireLeftAndRightList.add(ShapeMatrix.FIRE_SIDE_1);
        fireLeftAndRightList.add(ShapeMatrix.FIRE_SIDE_2);
        this.leftFire = new RocketFire(fireLeftAndRightList);
        this.rightFire = new RocketFire(fireLeftAndRightList);
    }
    ...
    private void checkBorders() {
        ...
        if (y+height>MoonLanderGame.HEIGHT){
            y= MoonLanderGame.HEIGHT-height;
            speedY=0;
        }
    }
